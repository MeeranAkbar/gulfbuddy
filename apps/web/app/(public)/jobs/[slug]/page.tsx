...
import { getJobListingBySlug } from '../../../../lib/search/jobs';
...
export default async function DetailPage({ params }: Props) {
  ...
  const listing = getJobListingBySlug(resolvedParams.slug);
    ...
    <div className="bg-[var(--background)] pb-24 animate-in fade-in duration-700">
      ...
      <div className="sticky top-0 z-50 border-b border-[var(--border-subtle)] bg-[var(--surface)]/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1380px] items-center justify-between px-5 py-4 xl:px-8">
          <Link href="/jobs/search" className="flex items-center gap-2 text-sm font-semibold text-[var(--text-secondary)] hover:text-[var(--text-primary)]">
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-[1fr_400px]">
          ...
          <div>
            <div className="sticky top-28 rounded-[2rem] border border-[var(--border-default)] bg-[var(--surface)] p-8 shadow-[var(--shadow-md)]">
              ...
              <h2 className="mt-2 text-4xl font-bold tracking-tight text-[var(--text-primary)]">{listing.salaryLabel || 'Price on request'}</h2>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button className="flex items-center justify-center rounded-2xl bg-green-600 px-6 py-4 text-sm font-bold text-white transition hover:brightness-110 shadow-lg">
                    Call Agent
                  </button>
