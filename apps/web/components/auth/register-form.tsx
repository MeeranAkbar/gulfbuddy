  ...
  return (
    <div className="mt-8">
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="name" className="block text-sm font-medium leading-6 text-[var(--text-primary)]">
            Full Name
          </label>
      ...
      <p className="mt-10 text-center text-sm text-[var(--text-secondary)]">
        ...
        <Link href="/login" className="font-semibold leading-6 text-brand-primary hover:text-brand-primary/80">
          Sign in instead
        </Link>
      </p>
    </div>
